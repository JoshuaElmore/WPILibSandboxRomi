...
public class TankDriveCommand extends CommandBase {
   ...
   */
  public TankDriveCommand(RomiDrivetrain subsystem, DoubleSupplier leftSpeed , DoubleSupplier rightSpeed) 
  {
  ...
  @Override
  public void execute() {
    romiDrivetrain.tankDrive(leftSpeed.getAsDouble(), rightSpeed.getAsDouble());
  }
